...
export default function HowCampaignsWorkModal({
  isOpen,
  onClose,
}: HowCampaignsWorkModalProps) {
  return (
    <Modal
      visible={isOpen}
      transparent
            ...
            >
              ...
              <View className="p-3 rounded-xl border bg-amber-400/10 border-amber-400/20 mb-3">
                ...
                <Text className="text-xs text-[#bdbdbd] leading-[18px]">
                  Before you can schedule your Campaigns, register your phone
                  number in Settings → Profile. This is required to receive test
                  messages.
                </Text>
              </View>
                ...
                <View className="flex-row items-center gap-2.5 mb-2">
                  ...
                  <View className="flex-row items-center gap-2 flex-1">
                    ...
                    <View className="px-2 py-1 rounded-lg bg-sky-300">
                      <Plus color="#000000" size={10} />
                    </View>
                  </View>
                </View>
                <Text className="text-xs text-[#bdbdbd] leading-[18px]">
                  Start by creating a new campaign. You can schedule up to 3
                  campaigns at once to keep your clients engaged.
                </Text>
              </View>
