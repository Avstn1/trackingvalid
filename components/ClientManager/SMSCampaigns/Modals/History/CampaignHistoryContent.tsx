...
interface CampaignHistoryContentProps {
  onClose: () => void;
  session: any;
  activeTab: string;
...
export default function CampaignHistoryContent({ onClose, session, activeTab, onTabChange, tabOptions }: CampaignHistoryContentProps) {
  ...
  // Reset view when component unmounts or view changes
  useEffect(() => {
    return () => {
      setView('list');
