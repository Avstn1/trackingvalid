        ...
        <View className="flex-1">
                    ...
                    {editingId === exp.id ? (
                      ...
                      <View className="gap-3">
                        ...
                        <View className="flex-row flex-wrap gap-2">
                          {(['once', 'weekly', 'monthly', 'yearly'] as const).map((freq) => (
                            <TouchableOpacity
                              ...
                              className="px-3 py-2 rounded-lg"
                              style={{
                                backgroundColor: editFrequency === freq ? COLORS.primaryGlow : COLORS.surface,
                                borderWidth: 1,
                                borderColor: editFrequency === freq ? COLORS.primary : COLORS.glassBorder,
                                opacity: isFieldLocked ? 0.5 : 1,
                              }}
                            >
                              <Text
                                className="text-xs font-semibold"
                                style={{ color: editFrequency === freq ? COLORS.primary : COLORS.textSecondary }}
                              >
                          ...
                          <View className="flex-row flex-wrap gap-2">
                            {DAYS.map((day) => (
                              <TouchableOpacity
                                ...
                                style={{
                                  backgroundColor: editSelectedDays.includes(day) ? COLORS.primaryGlow : COLORS.surface,
                                  borderWidth: 1,
                                  borderColor: editSelectedDays.includes(day) ? COLORS.primary : COLORS.glassBorder,
                                  opacity: isFieldLocked ? 0.5 : 1,
                                }}
                              >
                                <Text
                                  className="text-xs font-semibold"
                                  style={{ color: editSelectedDays.includes(day) ? COLORS.primary : COLORS.textSecondary }}
                                >
                                  {day}
                                </Text>
                              </TouchableOpacity>
                        ...
                        {editFrequency === 'monthly' && (
                          <View>
                            <Text className="text-xs mb-2" style={{ color: COLORS.textSecondary }}>Day of Month</Text>
                            <TextInput
                        ...
                        {editFrequency === 'yearly' && (
                          <View className="gap-2">
                            <View>
                              <Text className="text-xs mb-2" style={{ color: COLORS.textSecondary }}>Month</Text>
                                ...
                                <View className="flex-row gap-2">
                                  {MONTHS.map((m, idx) => (
                                    <TouchableOpacity
                                      ...
                                      className="px-3 py-2 rounded-lg"
                                      style={{
                                        backgroundColor: editYearlyMonth === idx ? COLORS.primaryGlow : COLORS.surface,
                                        borderWidth: 1,
                                        borderColor: editYearlyMonth === idx ? COLORS.primary : COLORS.glassBorder,
                                        opacity: isFieldLocked ? 0.5 : 1,
                                      }}
                                    >
                                      <Text
                                        className="text-xs font-semibold"
                                        style={{ color: editYearlyMonth === idx ? COLORS.primary : COLORS.textSecondary }}
                                      >
                                        {m}
                                      </Text>
                                    </TouchableOpacity>
                            ...
                            <View>
                              <Text className="text-xs mb-2" style={{ color: COLORS.textSecondary }}>Day</Text>
                              <TextInput
                                value={editYearlyDay}
                        ...
                        {/* Start Date */}
                        <View>
                          <Text className="text-xs mb-2" style={{ color: COLORS.textSecondary }}>Start Date</Text>
                          <TouchableOpacity
                        ...
                        {/* End Date */}
                        <View>
                          <Text className="text-xs mb-2" style={{ color: COLORS.textSecondary }}>End Date (Optional)</Text>
                          <TouchableOpacity
                            onPress={() => {
                        ...
                        <View className="flex-row gap-2 justify-end mt-2">
                          ...
                          >
                            <Text className="font-semibold text-sm" style={{ color: COLORS.textPrimary }}>Cancel</Text>
                          </TouchableOpacity>
                          <TouchableOpacity
                          ...
                          >
                            <Text className="font-semibold text-sm" style={{ color: COLORS.textPrimary }}>Save</Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    ) : (
                      ...
                      <View>
                        <View className="flex-row justify-between items-start mb-2">
                          <View className="flex-1">
                            <Text className="font-semibold text-base mb-1" style={{ color: COLORS.textPrimary }}>
                              {exp.label}
                            </Text>
                            <Text className="text-sm" style={{ color: COLORS.textSecondary }}>
                          ...
                          <View className="flex-row gap-2">
                            {canEdit && (
                              <TouchableOpacity
                                ...
                                style={{ backgroundColor: ACCENT_COLORS.amberGlow }}
                              >
                                <Edit2 size={16} color={ACCENT_COLORS.amber} />
                              </TouchableOpacity>
                            )}
                            <TouchableOpacity
                              onPress={() => handleDelete(exp.id)}
                              className="p-2 rounded-lg"
                              style={{ backgroundColor: COLORS.negativeMuted }}
                            >
                        ...
                        <View className="flex-row flex-wrap gap-2 mt-2">
                          {status.lastAdded && (
                            <View className="px-2 py-1 rounded-full" style={{ backgroundColor: COLORS.primaryGlow, borderWidth: 1, borderColor: COLORS.primary }}>
                          ...
                          {status.nextPending && (
                            <View className="px-2 py-1 rounded-full" style={{ backgroundColor: ACCENT_COLORS.amberGlow, borderWidth: 1, borderColor: ACCENT_COLORS.amber }}>
                              <Text className="text-xs font-medium" style={{ color: ACCENT_COLORS.amber }}>
                                Next: {status.nextPending}
                              </Text>
                            </View>
                          )}
                          {!status.lastAdded && !status.nextPending && (
                            <View className="px-2 py-1 rounded-full" style={{ backgroundColor: ACCENT_COLORS.grayGlow, borderWidth: 1, borderColor: ACCENT_COLORS.gray }}>
                              <Text className="text-xs font-medium" style={{ color: ACCENT_COLORS.gray }}>
          ...
          {totalPages > 1 && (
            ...
            >
              ...
              >
                <Text className="font-semibold text-sm" style={{ color: COLORS.textPrimary }}>Previous</Text>
              </TouchableOpacity>
              ...
              >
                <Text className="font-semibold text-sm" style={{ color: COLORS.textPrimary }}>Next</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
      ...
      >
        <View className="flex-1 justify-center items-center bg-black/70">
          ...
          >
            ...
            />
            <Text className="text-lg font-semibold mb-4 text-center" style={{ color: COLORS.textPrimary }}>
              Select Start Date
            </Text>
            <View
            ...
            <View className="flex-row gap-3 mt-6">
              ...
              <TouchableOpacity
                ...
                style={{ backgroundColor: COLORS.primary }}
              >
                <Text className="text-center font-semibold" style={{ color: COLORS.textPrimary }}>Done</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View className="flex-1 justify-center items-center bg-black/70">
          ...
          >
            ...
            <View className="flex-row gap-3 mt-6">
              ...
              >
                <Text className="text-center font-semibold" style={{ color: COLORS.textPrimary }}>Clear</Text>
              </TouchableOpacity>
              <TouchableOpacity
